...
from a_star_search import AStar    #import the code for a* algorithm
...
class CBS(object):
    ...
    def generate_plan(self, solution):
        ...
        for agent, path in solution.items():
            ...
            plan[agent] = [Point(state.location.x, state.location.y, 2) for state in path]
        return plan
...
def main():
    ...
    dimension2 = [5,5]
    agents2 = [
        dict(goal=[1,1], start=[2,2], name='agent0'),
        dict(goal=[1, 1], start=[2, 2], name='agent0')
    ]
    obstacles2 = [
        tuple(0,0)
